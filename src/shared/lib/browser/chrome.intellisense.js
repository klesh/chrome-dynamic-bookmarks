...
chrome.experimental.accessibility.setNativeAccessibilityEnabled = function (
  enabled
) {
  /// <summary>
...
chrome.fileBrowserHandlerInternal.selectFile = function (
  selectionParams,
  callback
) {
  /// <summary>
...
chrome.processes.getProcessInfo = function (
  processIds,
  includeMemory,
  callback
) {
...
//#endregion
//#region Chrome.storage Properties
chrome.storage.sync = new chrome.StorageArea();
chrome.storage.local = new chrome.StorageArea();
chrome.storage.managed = new chrome.StorageArea();
...
chrome.webRequestInternal.addEventListener = function (
  callback,
  filter,
  extraInfoSpec,
  eventName,
...
chrome.webRequestInternal.eventHandled = function (
  eventName,
  subEventName,
  requestId,
  response
...
chrome.webview = {};
chrome.webview.clearData = function (
  instanceId,
  options,
  dataToRemove,
  callback
...
chrome.webview.setPermission = function (
  instanceId,
  requestId,
  action,
  userInput,
